...
**Personal skills live in agent-specific directories (`~/.agents/skills/` for Codex, other platforms use their own skill directories).**
...
[Spawn focused agent with query: "React Router authentication error handling 401"]

# ✅ GOOD: Minimal example (20 words)
Partner: "How did we handle auth errors in React Router?"
You: Searching...
[Spawn focused agent → synthesis]
```
...
**IMPORTANT: Track each checklist item explicitly, preferably with `update_plan` when available.**
