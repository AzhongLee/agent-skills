...
NPM_CONFIG_REGISTRY=http://bnpm.byted.org npx -y @bytedance-dev/bytedcli@latest scm list-repo-version --repo-id 533180 --branch master --type online
...
NPM_CONFIG_REGISTRY=http://bnpm.byted.org npx -y @bytedance-dev/bytedcli@latest scm build-repo --repo-id 533180 --branch master --type offline
...
NPM_CONFIG_REGISTRY=http://bnpm.byted.org npx -y @bytedance-dev/bytedcli@latest scm get-build-log --repo-id 533180 "1.0.0.1686" --step building
```
