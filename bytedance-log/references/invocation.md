...
```bash
NPM_CONFIG_REGISTRY=http://bnpm.byted.org npx -y @bytedance-dev/bytedcli@latest --http-debug <command> [options]
NPM_CONFIG_REGISTRY=http://bnpm.byted.org npx -y @bytedance-dev/bytedcli@latest --http-print HBhbmt <command> [options]
NPM_CONFIG_REGISTRY=http://bnpm.byted.org npx -y @bytedance-dev/bytedcli@latest --http-trace-file /tmp/bytedcli.http.log --http-body-limit 4096 <command> [options]
```
